    ...
    main: {
        ...
        1: {
            ...
            16: {
                ...
                desc: `<span class='red'>Remove</span> tickspeed power's softcap.`,
                cost: E('e1.8e91'),
            },
            17: {
        ...
        3: {
            ...
            22: {
                unl() { return elemEffect(321)>=2 && hasElement(321) && tmp.mlt_unl },
                desc: `<span class='red'>Remove</span> the softcaps of Modificators self-boosts and boost their effect.`,
                cost: E('e1e80000'),
            },
        },
        4: {
            ...
            22: {
                unl() { return elemEffect(321)>=2 && hasElement(321) && tmp.mlt_unl },
                desc: `<span class='red'>Remove</span> the softcap from Dimensional Mass effect.`,
                cost: E('e3085000'),
            },
        },
    },
