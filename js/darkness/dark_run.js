const DARK_RUN = {
    ...
    mass_glyph_eff(i) {
        let x,
         g = (tmp.c16active || CHALS.inChal(17) || FERMIONS.onActive("17")|| CHALS.inChal(19)? i == 5 ? CHALS.inChal(19)?100000:hasCharger(10)?5:FERMIONS.onActive("17") && (hasElement(282))?100000:10 : CHALS.inChal(19)?100000:hasCharger(10)?50:FERMIONS.onActive("17") && (hasElement(282))?100000:10 : player.dark.run.glyphs[i]) / tmp.dark.glyph_weak
...
function updateDarkRunHTML() {
    ...
    for (let x = 0; x < MASS_GLYPHS_LEN; x++) {
        ...
        tmp.el["mass_glyph"+x].setHTML(
            tmp.c16active || CHALS.inChal(17) || FERMIONS.onActive("17")|| CHALS.inChal(19)? x == 5 ? CHALS.inChal(19)?100000:hasCharger(10)?5:FERMIONS.onActive("17") && (!hasElement(282))?100000:10 : CHALS.inChal(19)?100000:hasCharger(10)?50:FERMIONS.onActive("17") && (!hasElement(282))?100000:10 : player.dark.run.glyphs[x]
