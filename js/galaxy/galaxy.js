const GALAXY = {
 ...
 let y = player.galaxy.times.mul(0.5).max(1)
 if (player.galaxy.times.lt(10) && player.galaxy.times.gte(1)) x = x.mul(player.galaxy.times.pow(2)).max(1)
 if (player.galaxy.times.gte(10) && player.galaxy.times.lt(550)) x = x.mul(player.galaxy.times.pow(y)).max(1)
