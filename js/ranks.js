const RANKS = {
    ...
    desc: {
        ...
        tier: {
            ...
            '12': "Tier 4's reward is twice as effective and the softcap is <span class='red'>Remove</span>.",
        ...
        pent: {
            ...
            '15': "<span class='red'>Remove</span> 3rd softcap of Stronger's effect.",
        },
        hex: {
            '1': "reduce pent reqirements by 20%.",
            '4': "increase dark ray gain by +20% per hex.",
            '6': "<span class='red'>Remove</span> first softcap of normal mass gain.",
            '10': "<span class='red'>Remove</span> second softcap of normal mass gain.",
            '13': "<span class='red'>Remove</span> third softcap of normal mass gain.",
            '17': "<span class='red'>Remove</span> fourth softcap of normal mass gain.",
            '36': "<span class='red'>Remove</span> fifth softcap of normal mass gain.",
            '43': "hex 4's effect is overpowered.",
            '48': "<span class='red'>Remove</span> sixth softcap of normal mass gain.",
            '62': "<span class='red'>Remove</span> seventh softcap of normal mass gain.",
            '91': "+0.15 to matter exponents.",
            '157': "<span class='red'>Remove</span> eighth softcap of normal mass gain.",
        },
    },
    effect: {
        rank: {
    ...
    rewards: [
        {
            ...
            "28": `<span class='red'>Remove</span> all softcaps from Gluon Upgrade 4's effect.`,
        ...
        },
        {
            ...
            "127": `<span class='red'>Remove</span> all pre-Exotic scalings from Rank & Tier, but nullify C5's reward and Hybridized Uran-Astatine’s first effect for Rank & Tier.`,
...
const BEYOND_RANKS = {
    ...
    rewards: {
        ...
        2: {
            ...
            15: `<span class='red'>Remove</span> all scalings from mass upgrades 1-3.`,
        ...
        3: {
            ...
            12: `<span class='red'>Remove</span> the softcap of dark ray's fourth reward.`,
        ...
        5: {
            ...
            7: `<span class='red'>Remove</span> pre-meta scalings from Prestige Level.`,
            11: `<span class='red'>Remove</span> pre-ultra scalings from Pent.`,
