const ATOM = {
    ...
    quarkGain() {
        ...
        //x = x.mul(player.atom.quarks.gte(1) ? x.mul(player.atom.quarks.log(10).plus(1)) : E(1))
        x = x.mul(player.atom.quarks.gte(1) ? player.atom.quarks.mul(player.atom.quarks).add(1) : E(1))
