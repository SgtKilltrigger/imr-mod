const RADIATION = {
    ...
    ds_gain(i) {
        ...
        if (player.supernova.radiation.hz.gte(5)) x = x.mul((player.supernova.radiation.hz.log(10)).add(1))
        if (player.supernova.times.gte(40)) x = x.mul((player.supernova.times.sub(40).mul(0.1)).add(1))
